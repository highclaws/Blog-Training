...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('/dates', function(){
        ...
        echo '<br>';
        echo Carbon::addDays(1)->diffForHumans();
        echo '<br>';
        echo '<br>';
    ...
    Route::get('/mails', function(){
        $data = [
            'title'=>'Hi stuedent I hope you like the course',
            'content'=>'the laravel cours text'
        ];
        Mail::send('post', $data, function($message){
            $message->to('ouali.cherikh@gmail.com', 'ouali')->subject('hello stud');
        });
    });
